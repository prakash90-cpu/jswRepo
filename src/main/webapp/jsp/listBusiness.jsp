	...
	<%@ include file="Header.jsp"%>
		...
		<div class="w3-row-padding">
			...
			<div id="myTableList">
					...
					<thead>
						...
						<c:forEach var="list" items="${BusinessList}">
							<tr class="">
								...
								<td><a href="/jsw-report/master/editBusiness/${list.id}" class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a> <a
									href="/jsw-report/master/deletebusiness/${list.id}" class=" w3-margin-right"><i
				...
				<br />
				<center>
					<a href="/jsw-report/master/addBusiness">
