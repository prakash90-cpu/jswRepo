...
<form:form commandName="FunctionAppBean" action="/jsw-report/CORPController/submitNumberOfCasesCompletedCORP">				
				<table
...
function getCaseStudiedTable(thisVariable){
    ...
    $.ajax({                    
    	  url: '/JSW/NW/getCaseCreatedCompanyCompletedAR/'+firstColumnValue,     
    	  type: 'GET',
    	async:false,
    	cache:false,
