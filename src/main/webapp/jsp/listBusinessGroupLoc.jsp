			...
			<div id="myTableList">
				...
				<table
					...
					<thead>
						...
						<c:forEach var="list" items="${BusinessGroupLocation}">
							<tr class="">
								...
								<td><a href="/jsw-report/master/editBusinessGR/${list.businessId}/${list.locId}" class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a> <a
									href="/jsw-report/master/deletebusinessGroupLoc/${list.businessId}/${list.locId}" class=" w3-margin-right"><i
				...
				<br />
				<center>
					<a href="/jsw-report/master/addBusinessGroupLoc">
