...
<h2 class="w3-center w3-xxlarge"><i>AR</i></h2>
					<h4 class="w3-text-blue">
							<b>Report 5- Total cycle time taken to complete the process (Steps)
</b>
					</h4>
<form:form commandName="FunctionAppBean" action="/jsw-report/ARController/listTotalCycleTimeAR">				
					<table
...
<table 
   ...
   <c:forEach items="${listPeriod}" var="value">
						...
						<span  onclick="getCaseCreatedAll('<%=timeTaken[countTimeTaken++] %>', 'AR Total Cycle time taken to complete process')" class="w3-badge fa fa-download  w3-right w3-hover-blue"></span>
...
<td class="w3-center firstTd bus${listCases.name}" >${listCases.name}</td>
											 ...
											 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
		<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.day1}</td>
										<td style='cursor:pointer' class="w3-center" onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.day2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.day3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.day4}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.day5}</td>
											<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.day6}</td>
						
							<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.day7}</td>
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.week1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.week2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.week3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.week4}</td>
											
											
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.period1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.period2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByStageRow(this,'getTotalCycleTimeAR',0);">${listCases.period3}</td>
    </c:when>  
								...
								<u class="w3-hover-blue w3-hover-text-black"  onClick="getCaseStudiedTableByStage(this,'getTotalCycleTimeAR',0);"
								...
								<span onClick="getCaseStudiedTableByStage(this,'getTotalCycleTimeExcelAR',1);"  class="fa fa-download generateXLS w3-right"></span>
