			...
			<div id="myTableList">
				...
				<table
					...
					<thead>
						...
						<c:forEach var="list" items="${PayrollAreaList}">
							<tr class="">

								<td>${list.id}</td>
								<td>${list.payrollAreaName}</td>
								<td>${list.shortName}</td>
								<td>${list.businessgroupId}</td>
								<td>${list.businessId}</td>
								<td>${list.personnelAreaId}</td>
								

								<td><a href="/jsw-report/master/editPayrollArea/${list.id}" class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a> <a
									href="/jsw-report/master/deletePayrollArea/${list.id}" class=" w3-margin-right"><i
				...
				<br />
				<center>
					<a href="/jsw-report/master/addPayrollArea">
