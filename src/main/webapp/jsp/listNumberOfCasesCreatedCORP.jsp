...
<form:form commandName="FunctionAppBean" action="/jsw-report/mainController/submitNumberOfCasesCreatedCORP">				
				<table
...
function getCaseStudiedTable(thisVariable){
    ...
    $.ajax({                    
    	  url: '/JSW/NW/getCaseCreatedCompanyAR/'+firstColumnValue+"@"+secondColumnValue,     
    	  type: 'GET',
    	async:false,
    	cache:false,
