			...
			<div id="myTableList">
				...
				<table
					...
					<thead>
						...
						<c:forEach var="list" items="${BusinessGroupBusiness}">
							<tr class="">
							...
							<td><a
									href="/jsw-report/master/deletebusinessGroupBusiness/${list.businessId}/${list.locId}" class=" w3-margin-right"><i
				...
				<br />
				<center>
					<a href="/jsw-report/master/addBusinessGroupBusiness">
