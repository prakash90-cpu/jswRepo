...
<h2 class="w3-center w3-xxlarge"><i>Commercial</i></h2>
					<h4 class="w3-text-blue">
						<b>Report 9-Number of Cases pending for processing from Creation date (with PRTOPO)
</b>
					</h4>
				


<form:form commandName="FunctionAppBean" action="/jsw-report/CommController/listNumberOfCasesPendingWithPRTOPOCOMM">				
...
<select    style="width:50%">
				<option selected>15/30/45/60/60+ Day</option>  
		</select>
...
<br /> <br />
    ...
    <div class="w3-left"><label>Tabular</label>	
		...
		<!-- <h5 style="color:green">Title : Number of cases Pending</h5> -->
		 <div id="chartContainer" style="height:700px; width:75%;display:none">
  </div></center>
...
<table 
        ...
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '15/30/45/60+')}">
   ...
   <%--  </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '1/2/3/4/4+')}">
						...
						<span  onclick="getCaseCreatedAll('listCaseCreated', 'COMM Number of Cases Pending')" class="w3-badge fa fa-download  w3-right w3-hover-blue"></span>
  	...
  	<%-- 		
        ...
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '1/2/3/4/4+')}">
  			 ...
  			 --%>
    			...
    			>
    			<span  onclick="getCaseStudiedTableByBusinessGroup(this,'getCasesPendingExcelWithPRTOPOCOMM',1);" class="fa fa-download  w3-right w3-hover-blue"></span>
...
<td class="w3-center firstTd bus${listCases.name}" colorName="${listCases.color}">${listCases.stepName}</td>
									...
									<%-- 		 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3/7/11/15/15+')}">
		<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center" onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket4}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket5}</td>
										
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '15/30/45/60+')}"> --%>
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket4}</td>
  ...
  <%--   </c:when>  
 	...
 	<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingWithPRTOPOCOMM',0);">${listCases.bucket4}</td>
								...
								<u class="w3-hover-blue w3-hover-text-black"  onClick="getCaseStudiedTableByLocation(this,'getCasesPendingWithPRTOPOCOMM',0);"
								...
								<span onClick="getCaseStudiedTableByLocation(this,'getCasesPendingExcelWithPRTOPOCOMM',1);"  class="fa fa-download generateXLS w3-right"></span>
  			 ...
  			 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3/7/11/15/15+')}">
          <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingWithPRTOPOCOMM',0);">Total of all Role StepName</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingWithPRTOPOCOMM',0);">Total of all Role StepName</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingWithPRTOPOCOMM',0);">Total of all Role StepName</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingWithPRTOPOCOMM',0);">Total of all Role StepName</td>   
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingWithPRTOPOCOMM',0);">Total of all Role StepName</td>
   ...
   <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingWithPRTOPOCOMM',0);">Total of all Role StepName</td>
      ...
      <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingWithPRTOPOCOMM',0);">Total of all Role StepName</td>
  			...
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingWithPRTOPOCOMM',0);">Total of all Role StepName</td>
    			...
    			<td class="w3-center" onClick="getCaseStudiedTableByTotal(this,'getCasesPendingWithPRTOPOCOMM',0);" >Total of all column on totals  
    			
    			<span onClick="getCaseStudiedTableByTotal(this,'getCasesPendingWithPRTOPOCOMM',0);" class="fa fa-download  w3-right"></span></td>
 ...
 $(".busi").each(function(){
	...
	for(var count=1;count<totalTd;count++){
		...
		var contEachTd=0;
		 ...
		 if(count==totalTd-1)
		 $(this).parent().find('td:eq('+count+')').append("<br><a style='cursor:pointer' onclick=\"getCaseStudiedTableByBusinessGroup(this,'getCasesPendingWithPRTOPOCOMM',0)\" >"+contEachTd+"</a>");
		 else
			 $(this).parent().find('td:eq('+count+')').append("<br><a style='cursor:pointer' onclick=\"getCaseStudiedTableByBusinessGroupRow(this,'getCasesPendingWithPRTOPOCOMM',0)\" >"+contEachTd+"</a>");
   ...
   endDate=currentDate.split("-")[5].trim()+"-"+currentDate.split("-")[4].trim()+"-"+currentDate.split("-")[3].trim();
	...
	var json="{";
	  json+="'currentRole':'"+busiGroup+"',";
	   /*  json+="'dateFrom':'"+$("#dateFrom").val()+"','dateTo':'"+$("#dateTo").val()+"',";
 */
	    var currentBucket=$(thisVariable).parent().parent().parent().find("tr:first").children('td:eq('+$(thisVariable).parent().index()+')').text();
...
var legendColorData=legendColor();
 ...
 function graphNumberOfCase(){
 	...
 	$("#titleDiv").remove(); 
    $('#chartContainer').prepend('<html><div id="titleDiv"> <h4 style="color:purple">Title : Number of cases Pending For Processing With PR to PO</h5></div></html>');
