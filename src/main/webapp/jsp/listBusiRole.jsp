			...
			<div id="myTableList">
				...
				<table
					...
					<thead>
						...
						<c:forEach var="list" items="${BusiRoleList}">
							<tr class="">

								<td>${list.busiRoleId}</td>
								<td>${list.roleName}</td>
								<td>${list.ldapGroupName}</td>
								<td>${list.function}</td>
								...
								<td><a href="/jsw-report/master/editBusiRole/${list.busiRoleId}" class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a> <a
									href="/jsw-report/master/deleteBusiRole/${list.busiRoleId}" class=" w3-margin-right"><i
				...
				<br />
				 <center>
					<a href="/jsw-report/master/addBusiRole">
