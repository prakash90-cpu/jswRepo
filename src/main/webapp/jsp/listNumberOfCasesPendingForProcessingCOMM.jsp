...
<h2 class="w3-center w3-xxlarge"><i>Commercial</i></h2>
					<h4 class="w3-text-blue">
						<b>Report 8-Number of Cases pending for processing from the last role start time (w/o PRTOPO)
</b>
					</h4>
...
<form:form commandName="FunctionAppBean" action="/jsw-report/CommController/listCasesPendingForProcessingCOMM">				
  ...
  %>
        ...
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '1/2/3/4/4+')}">
  			 ...
  			 --%>
    			...
    			>
    			<span  onclick="getCaseStudiedTableByBusinessGroup(this,'getCasesPendingForProcessingExcelCOMM',1);" class="fa fa-download generateXLS w3-right w3-hover-blue"></span>
...
<td class="w3-center firstTd bus${listCases.name}" colorName="${listCases.color}">${listCases.stepName}</td>
										...
										<%-- 	
											 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '2/7/15/15+')}"> --%>
		<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center" onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket4}</td>
		
										
	<%-- 					
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '15/30/45/45+')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket4}</td>
 	...
 	<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket4}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesPendingForProcessingCOMM',0);">${listCases.bucket5}</td>
				 ...
				 --%>							
								...
								onclick="getCaseStudiedTableByLocation(this,'getCasesPendingForProcessingCOMM',0);" >
								
								${listCases.count}
								</u>
								
								<span onClick="getCaseStudiedTableByLocation(this,'getCasesPendingForProcessingExcelCOMM',1);"  class="fa fa-download generateXLS w3-right"></span>
        ...
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3/7/11/15/15+')}">
          <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingForProcessingCOMM',0);">Total of all Role StepName</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingForProcessingCOMM',0);">Total of all Role StepName</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingForProcessingCOMM',0);">Total of all Role StepName</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingForProcessingCOMM',0);">Total of all Role StepName</td>   
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingForProcessingCOMM',0);">Total of all Role StepName</td>
      ...
      <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingForProcessingCOMM',0);">Total of all Role StepName</td>
  			...
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingForProcessingCOMM',0);">Total of all Role StepName</td>
    			...
    			<td class="w3-center" onClick="getCaseStudiedTableByTotal(this,'getCasesPendingForProcessingCOMM',0);" >Total of all column on totals 
    			
    			
    			 <span  onClick="getCaseStudiedTableByTotal(this,'getCasesPendingForProcessingCOMM',0);" class="fa fa-download generateXLS w3-right"></span></td>
 ...
 $(".busi").each(function(){
	...
	for(var count=1;count<totalTd;count++){
		...
		var contEachTd=0;
		 ...
		 if(count==totalTd-1)
		 $(this).parent().find('td:eq('+count+')').append("<br><a style='cursor:pointer'  onclick=\"getCaseStudiedTableByBusinessGroup(this,'getCasesPendingForProcessingCOMM',0)\"  >"+contEachTd+"</a>");
		 else
			 $(this).parent().find('td:eq('+count+')').append("<br><a style='cursor:pointer' onclick=\"getCaseStudiedTableByBusinessGroupRow(this,'getCasesPendingForProcessingCOMM',0)\" >"+contEachTd+"</a>");
...
var legendColorData=legendColor();
 ...
 function graphNumberOfCase(){
 	...
 	var aliasValue=aliasData();
 	 ...
 	 $("#titleDiv").remove(); 
     $('#chartContainer').prepend('<html><div id="titleDiv"> <h4 style="color:purple">Title : Number of cases Pending From Last Role Start Time </h5></div></html>');
 	var descData='';
