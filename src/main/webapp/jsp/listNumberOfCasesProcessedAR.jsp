...
<h2 class="w3-center w3-xxlarge"><i>AR</i></h2>
					<h4 class="w3-text-blue">
						<b>Report 3- Number of Cases Processed by User (Steps )</b>
					</h4>
				



<form:form commandName="FunctionAppBean" action="/jsw-report/ARController/listNumberOfCasesProcessedAR">				
...
<div class='w3-container w3-round-xxlarge' style="background-color:#e3ecf9">
 ...
 <input   onChange="$('#listCaseCreated<%=countGraphId %>').hide();$('#chartContainer<%=countGraphId %>').show();$('#table-btn').show();graphNumberOfCaseProcess($('#chartContainer<%=countGraphId %>'),<%=countGraphId %>);" class="w3-radio" type="radio" name="graph<%=countGraphId %>">
		 ...
		 <div id="chartContainer<%=countGraphId %>" class="w3-center" style="height: 500px; width:100%;display:none"></div>
		    ...
		    <p class="w3-right currentDate"></p>
					Number of cases <b>${listOuterCases.name}</b><%-- (step <%=(countGraphId++)+1 %>) --%>  by the users
 <table  class="w3-table-all w3-hoverable w3-striped w3-border w3-small w3-center processTable process" stepname="${listOuterCases.name}">
   ...
   <c:forEach items="${listPeriod}" var="value">
						...
						<span title="download table"  onclick="getCaseCreatedAll('listCaseCreated<%=countGraphId++%>', 'AR Number of Case Processed by user')" class="w3-badge fa fa-download w3-blue  w3-right w3-hover-green"></span>
...
<tr class="busi">
  ...
  <c:otherwise>
    <td class="w3-center firstTd">-</td>
										 ...
										 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
		<td class="w3-center stepName" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.day1}</a></td>
										<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.day2}</a></td>
											<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.day3}</a></td>
													<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.day4}</a></td>
										<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.day5}</a></td>
											<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.day6}</a></td>
						
							<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.day7}</a></td>
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
   		<td class="w3-center stepName" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.week1}</a></td>
										<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.week2}</a></td>
											<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.week3}<a></td>
													<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.week4}<a></td>
											
											
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
   		<td class="w3-center stepName" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.period1}</a></td>
										<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.period2}</a></td>
											<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAR',0);"><a>${listCases.period3}</a></td>
    </c:when>  
								...
								<u onclick="getCaseStudiedTableByUserName(this,'getCasesProcessedAR',0);" class="w3-hover-blue w3-hover-text-black">${listCases.count}</u>
								
								<span  onclick="getCaseStudiedTableByUserName(this,'getCasesProcessedExcelAR',1);" class="fa fa-download  w3-right w3-text-blue w3-hover-blue">
  			 ...
  			 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
          <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Day1</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Day2</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Day3</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Day4</td>   
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Day5</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Day6</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Day7</td>
						
						
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
         <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Week1</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Week2</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Week3</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Week4</td>
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
      <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Month1</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Month2</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAR',0);">Total of all Month1</td>
    </c:when>  
    			...
    			<td class="w3-center" >Total of all column on totals
    				...
    				<span  onclick="getCaseStudiedTableByTotal(this,'getCasesProcessedAR',0);" class="fa fa-download w3-right w3-hover-blue"></span>
 ...
 */
  ...
  function getCaseStudiedTableByUserName(thisVariable,ajaxUrl){
	...
	//alert("table");
	 ...
	 /*    if(stageNameProcess=="In Progress"||stageNameProcess=="On Hold"||stageNameProcess=="Cancelled"||stageNameProcess=="Complete")
	    	  json+="'process':'other',";
	    else
	    json+="'process':'"+stageNameProcess.split("-")[1].trim()+"',";
	   */  
