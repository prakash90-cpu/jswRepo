...
<body ng-App="myApp" ng-Controller="myCtrl">
	...
	<%@ include file="Header.jsp"%>
		...
		<br />
		<form:form class="w3-container" commandName="LocationBean" method="POST"  action="/jsw-report/master/submitLocation" >
          ...
          <form:input type="hidden" path="locationId"/>
			...
			<p>
				...
				<form:input path="locationName" class="w3-input w3-border"
					name="approver" type="text" placeholder=" Location Name" />
			</p>
            <p>

				<form:input path="locationShortName" class="w3-input w3-border"
  ...
  <form:input type="color" path="color"   />
			...
			<p>
              <c:choose>
    <c:when test="${LocationBean.getIsActive()=='Y'}">
