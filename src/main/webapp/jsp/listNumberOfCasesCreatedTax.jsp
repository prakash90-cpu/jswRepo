...
<form:form commandName="FunctionAppBean" action="/jsw-report/TAXController/listNumberOfCasesCreatedTax">				
...
<table 
   ...
   <c:forEach items="${listPeriod}" var="value">
						...
						<span  onclick="getCaseCreatedAll('listCaseCreated', 'TAX Number of Case Created')" class="w3-badge fa fa-download  w3-right w3-hover-blue"></span>
  ...
  %>
    	...
    	<td class="w3-center">Total of all ${listCases.name} Locations</td>
  			...
  			<td class="w3-center" >Total of all ${listCases.name} Locations</td>
    			...
    			<span  onclick="getCaseStudiedTableByBusinessGroup(this,'getCaseCreatedCompanyExcelTax',1)" class="fa fa-download w3-right w3-hover-blue"></span>
...
<td class="w3-center firstTd bus${listCases.name}" colorName="${listCases.color}" aliasName="${listCases.alias}" >${listCases.location}</td>
											 ...
											 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
		<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.day1}</td>
										<td style='cursor:pointer' class="w3-center" onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.day2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.day3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.day4}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.day5}</td>
											<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.day6}</td>
						
							<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.day7}</td>
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.week1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.week2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.week3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.week4}</td>
											
											
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.period1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.period2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCaseCreatedCompanyTax',0);">${listCases.period3}</td>
    </c:when>  
								...
								<u class="w3-hover-blue w3-hover-text-black"
								 style="cursor:pointer"  onClick="getCaseStudiedTableByLocation(this,'getCaseCreatedCompanyTax',0);"
								 >
								
								${listCases.count}
								</u>
								
								<span onClick="getCaseStudiedTableByLocation(this,'getCaseCreatedCompanyExcelTax',1)"  class="fa fa-download  w3-right"></span>
  			 ...
  			 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
          <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyTax',0);" >Total of all Business Locations</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyTax',0);">Total of all Business Locations</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyTax',0);">Total of all Business Locations</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyTax',0);">Total of all Business Locations</td>   
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyTax',0);">Total of all Business Locations</td>
      ...
      <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyTax',0);">Total of all Business Locations</td>
  			...
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyTax',0);">Total of all Business Locations</td>
    			...
    			<span  onClick="getCaseStudiedTableByTotal(this,'getCaseCreatedCompanyExcelTax',1)"  class="fa fa-download w3-right"></span></td>
 ...
 $(".busi").each(function(){
	...
	for(var count=1;count<totalTd;count++){
		...
		var contEachTd=0;
		 ...
		 if(count==totalTd-1)
		 $(this).parent().find('td:eq('+count+')').append("<br><a style='cursor:pointer' onclick=\"getCaseStudiedTableByBusinessGroup(this,'getCaseCreatedCompanyTax',0);\" \" >"+contEachTd+"</a>");
		 else
			 $(this).parent().find('td:eq('+count+')').append("<br><a style='cursor:pointer' onclick=\"getCaseStudiedTableByBusinessGroupRow(this,'getCaseCreatedCompanyTax',0);\" >"+contEachTd+"</a>");
	...
	for(var count=1;count<totalTd;count++){
		...
		contEachTd+= parseInt( $(this).parent().find('td:eq('+count+')').text().replace(/[^0-9]/g,''));
		 ...
		 if(count==totalTd-1)
			 $("#firstTr").parent().find("tr").last().find('td:eq('+count+')').append("<br><a onClick=\"getCaseStudiedTableByTotal(this,'getCaseCreatedCompanyTax',0)\" style='cursor:pointer'>"+contEachTd+"</a>");	 
		 else
