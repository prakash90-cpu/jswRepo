...
<form:form commandName="FunctionAppBean" action="/jsw-report/ApController/listCasesPendingForProcessingAP">				
...
<table 
	...
	<%-- 					
        ...
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '1/2/3/4/4+')}">
						...
						<span  onclick="getCaseCreatedAll('listCaseCreated', 'AP Number of Case Pending for Processing from last Role start time')" class="w3-badge fa fa-download  w3-right w3-hover-blue"></span>
...
<td class="w3-center firstTd bus${listCases.name}" colorName="${listCases.color}">${listCases.name}</td>
		...
		<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center" onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket4}</td>
										<%-- <td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket5}</td>
										 --%>
						
  <%--   </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket4}</td>
 	...
 	<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingForProcessingAP',0)">${listCases.bucket4}</td>
								...
								<u class="w3-hover-blue w3-hover-text-black" onClick="getCaseStudiedTableByRole(this,'getCasesPendingForProcessingAP',0)"
								...
								<span onClick="getCaseStudiedTableByRole(this,'getCasesPendingForProcessingExcelAP',1)"  class="fa fa-download w3-right"></span>
      ...
      <td class="w3-center">Total of all Role StepName</td>
  			...
  			<td class="w3-center">Total of all Role StepName</td>
    			...
    			<td class="w3-center" onClick="getCaseStudiedTableByTotal(this,'getCasesPendingForProcessingAP',0)" >Total of all column on totals  <span   class="fa fa-download generateXLS w3-right"></span></td>
	...
	for(var count=1;count<totalTd;count++){
		...
		var contEachTd=0;
		 ...
		 $(this).parent().find('td:eq('+count+')').append("<br><a style='cursor:pointer' \" >"+contEachTd+"</a>");
			 ...
			 $(this).parent().find('td:eq('+count+')').append("<br><a style='cursor:pointer' onclick=\"getCaseStudiedTableByBusinessGroupRow(this,'getCasesPendingForProcessingAP',0)\" >"+contEachTd+"</a>");
