					...
					<thead>
						...
						<c:forEach var="list" items="${BusiRoleList}">
							<tr class="">
								...
								<td><a href="/jsw-report/master/editBusiRole/${list.id}" class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a> <a
									href="/jsw-report/master/deleteBusiRole/${list.id}" class=" w3-margin-right"><i
