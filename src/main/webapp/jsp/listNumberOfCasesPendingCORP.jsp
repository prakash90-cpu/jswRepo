			...
			<div id="myTableList">
				<div class="w3-container">
					...
					<h3 class="w3-text-blue">
						<b>Number of Cases Pending</b>
					</h3>
				</div>
 
<form:form commandName="FunctionAppBean" action="/jsw-report/mainController/submitNumberOfCasesPendingCORP">				
				<table
...
<p>
  ...
  <% String tablesName[]={"Roles","Business"};
  int countTable=0;%>
			<c:forEach var="listOuterCases" items="${listCasesCreated}">							
					
					 
		
Number of cases pending with the <%=tablesName[countTable]%>
 <table  class="w3-table-all w3-hoverable w3-striped w3-border w3-small w3-center">
					<thead>
						<b><tr class="w3-text-white w3-blue w3-center w3-medium">
						
						
							<td class="w3-center"><%=tablesName[countTable++]%> Name</td>
						
						
						<td class="w3-center">Bucket 1</td>
						
						<td class="w3-center">Bucket 2</td>
						
						<td class="w3-center">Bucket 3</td>
						...
						<c:forEach var="listCases" items="${listOuterCases}">
