					...
					<thead>
						...
						<c:forEach var="list" items="${StepList}">
							<tr class="">
								...
								<td><a href="/jsw-report/master/editSteps/${list.stepId}" class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a> <a
									href="/jsw-report/master/deleteSteps/${list.stepId}" class=" w3-margin-right"><i
