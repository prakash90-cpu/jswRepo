...
<form:form commandName="FunctionAppBean" action="/jsw-report/ApController/listCasesCompletedCumulativelyAP">				
...
<br /> <br />
    ...
    <div class="w3-left"><label>Tabular</label>	
		...
		<!-- <h5 style="color:green">Title : Number of cases completed Cumulative</h5> -->
		 <div id="chartContainer" style="height:500px; width:100%;display:none">
  </div></center>
...
<table 
        ...
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3/7/11/15/15+')}">
					 ...
					 --%>
						...
						<span  onclick="getCaseCreatedAll('listCaseCreated', 'AP Number of Case Completed Cumulatively')" class="w3-badge fa fa-download  w3-right w3-hover-blue"></span>
	...
	<%-- 					
        ...
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '1/2/3/4/4+')}">
						...
						<span  onclick="getCaseCreatedAll()" class="w3-badge fa fa-download  w3-right w3-hover-blue"></span>
  ...
  <%--   </c:when>  
        ...
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '1/2/3/4/4+')}">
  			 ...
  			 --%>
    			...
    			<%-- <td class="w3-center" onclick="getCaseStudiedTableByBusinessGroup(this,'getCasesCompletedCumulativelyAP',0)"
    			
    			title="Total of all period on ${listCases.name} Role"
    			>
    			<span  onclick="getCaseStudiedTableByBusinessGroup(this,'getCasesCompletedCumulativelyAP',0)" class="fa fa-download generateXLS w3-right w3-hover-blue"></span>
...
<td class="w3-center firstTd bus${listCases.name}" colorName="${listCases.color}" aliasName="${listCases.alias}">${listCases.stepName}</td>
				...
				<%-- 			
											 ...
											 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3/7/11/15/15+')}"> --%>
		<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center" onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket4}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket5}</td>
										
						
  <%--   </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '15/30/45/45+')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket4}</td>
 	...
 	<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByLocationRow(this,'getCasesCompletedCumulativelyAP',0);">${listCases.bucket4}</td>
								...
								<%-- <td  class="w3-center w3-text-blue" onClick="getCaseStudiedTableByLocation(this,'getCasesCompletedCumulativelyAP',0);">
								...
								<span onClick="getCaseStudiedTableByLocation(this,'getCasesCompletedCumulativelyAP',0)"  class="fa fa-download generateXLS w3-right"></span>
  			 ...
  			 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3/7/11/15/15+')}"> 
          <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesCompletedCumulativelyAP',0);">Total of all Role StepName</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesCompletedCumulativelyAP',0);">Total of all Role StepName</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesCompletedCumulativelyAP',0);">Total of all Role StepName</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesCompletedCumulativelyAP',0);">Total of all Role StepName</td>   
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesCompletedCumulativelyAP',0);">Total of all Role StepName</td>
      ...
      <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesCompletedCumulativelyAP',0);">Total of all Role StepName</td>
  			...
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesCompletedCumulativelyAP',0);">Total of all Role StepName</td>
    			...
    			<td class="w3-center" onClick="getCaseStudiedTableByTotal(this,'getCasesCompletedCumulativelyAP',0);" >Total of all column on totals  
	...
	for(var count=1;count<totalTd;count++){
		...
		var contEachTd=0;
		 ...
		 $(this).parent().siblings().find(".bus"+busiGroup).each(function(){
			 ...
			 $(this).parent().find('td:eq('+count+')').append("<br><a style='cursor:pointer' onclick=\"getCaseStudiedTableByBusinessGroupRow(this,'getCasesCompletedCumulativelyAP')\" >"+contEachTd+"</a>");
...
var bucketTo=bucketValue.split(" ")[3];
	...
	var json="{";
	  json+="'busiGrp':'"+busiGroup+"',";
	    ...
	    json+="'bucketFrom':'"+bucketFrom+"',";
//alert($(thisVariable).parent().index());
	    if($(thisVariable).parent().index()!=5)
	    json+="'bucketTo':'"+bucketTo+"',";
	 // var dateTo=$("#dateTo").val().split("-")[2]+"-"+$("#dateTo").val().split("-")[1]+"-"+$("#dateTo").val().split("-")[0];
	//  json+="'dateFrom':'"+startDate+"','dateTo':'"+endDate+"',";
	  var dropdownsCount=1;
