...
<body ng-App="myApp" ng-Controller="myCtrl">
	...
	<%@ include file="Header.jsp"%>
		...
		<h3>
			<b>Delete Extraction Process </b>
		</h3>
		<br />
		
		
		
		<form:form class="w3-container" commandName="ExtractionBean" method="POST"  action="/jsw-report/externalSystems/submitDeleteExtraction" >
...
Start Time
				<form:input path="startTime" class="w3-input w3-border"
					 type="text" placeholder=" HH:MIN:SS"  style="width:300px" />
			</label></td>
...
End Time
			...
			<input type="submit"  value="delete" class="w3-btn w3-right">
		</form:form>
