...
<h2 class="w3-center w3-xxlarge"><i>AR</i></h2>
					<h4 class="w3-text-blue">
						<b>Report 6-Number of Cases pending for processing (Creation date)
</b>
					</h4>
				


<form:form commandName="FunctionAppBean" action="/jsw-report/ARController/listNumberOfCasesPendingAR">				
...
<table 
  ...
  <%--   </c:when>  
   ...
   --%>
						...
						<span  onclick="getCaseCreatedAll('listCaseCreated', 'AR Number of Cases Pending')" class="w3-badge fa fa-download  w3-right w3-hover-blue"></span>
...
<td class="w3-center firstTd bus${listCases.name}" colorName="${listCases.color}">${listCases.name}</td>
		...
		<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center" onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket4}</td>
				<%-- 						<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket5}</td>
									<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket6}</td>	 --%>
						
<%--     </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '15/30/45/45+')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket4}</td>
 	...
 	<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByRoleRow(this,'getCasesPendingAR',0)">${listCases.bucket4}</td>
				 ...
				 --%>							
								...
								<u class="w3-hover-blue w3-hover-text-black"  onClick="getCaseStudiedTableByRole(this,'getCasesPendingAR',0)"
								...
								<span onClick="getCaseStudiedTableByRole(this,'getCasesPendingExcelAR',1)"  class="fa fa-download  w3-right"></span>
  			 ...
  			 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3/7/11/15/15+')}">
          <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingAR',0)" >Total of all Role </td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingAR',0)">Total of all Role </td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingAR',0)">Total of all Role </td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingAR',0)">Total of all Role </td>   
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingAR',0)">Total of all Role </td>
      ...
      <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingAR',0)">Total of all Role </td>
  			...
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesPendingAR',0)">Total of all Role </td>
    			...
    			<td class="w3-center" onClick="getCaseStudiedTableByTotal(this,'getCasesPendingAR',0)" >Total of all column on totals  <span   class="fa fa-download generateXLS w3-right"></span></td>
