...
<form:form commandName="FunctionAppBean" action="/jsw-report/RTRController/listRoleWiseTimeTakenRTR">				
...
<br /> <br />
 ...
 <input onChange="$('#listCaseCreated<%=countTimeTaken %>').hide();$('#chartContainer<%=countTimeTaken %>').show();$('#table-btn').show();graphNumberOfCaseProcessComm($('#chartContainer<%=countTimeTaken %>'),<%=countTimeTaken %>);" class="w3-radio" type="radio" name="graph<%=countTimeTaken%>">
		 ...
		 <div id="chartContainer<%=countTimeTaken %>" class="w3-center" style="height:60%; width:100%;display:none"></div>
...
<table 
					...
					<thead>
						<tr class="w3-center " style="background-color: #004d99;color:white" id="firstTr">
   ...
   <c:forEach items="${listPeriod}" var="value">
						...
						<span  onclick="getCaseCreatedAll('<%=timeTaken[countTimeTaken++] %>', 'RTR Role wise time taken to complete process')" class="w3-badge fa fa-download  w3-right w3-hover-blue"></span>
...
<td class="w3-center firstTd bus${listCases.name}" >${listCases.name}</td>
											 ...
											 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
		<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.day1}</td>
										<td style='cursor:pointer' class="w3-center" onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.day2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.day3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.day4}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.day5}</td>
											<td class="w3-center" style='cursor:pointer' onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.day6}</td>
						
							<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.day7}</td>
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.week1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.week2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.week3}</td>
													<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.week4}</td>
											
											
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
   		<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.period1}</td>
										<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.period2}</td>
											<td style='cursor:pointer' class="w3-center"  onClick="getCaseStudiedTableByUserNameRow(this,'getRoleWiseTimeTakenRTR',0);">${listCases.period3}</td>
    </c:when>  
								...
								<u class="w3-hover-blue w3-hover-text-black"  onClick="getCaseStudiedTableByUserName(this,'getRoleWiseTimeTakenRTR',0);"
								 style="cursor:pointer">
								
								${listCases.count}
								</u>
								
								<span onClick="getCaseStudiedTableByUserName(this,'getRoleWiseTimeTakenExcelRTR',1)"  class="fa fa-download w3-right"></span>
  			 ...
  			 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
          <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getRoleWiseTimeTakenRTR',0);"></td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getRoleWiseTimeTakenRTR',0);"></td>
  		       <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getRoleWiseTimeTakenRTR',0);"></td>
  	       <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getRoleWiseTimeTakenRTR',0);"></td>
  		       <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getRoleWiseTimeTakenRTR',0);"></td>
       ...
       <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getRoleWiseTimeTakenRTR',0);"></td>
  	       <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getRoleWiseTimeTakenRTR',0);"></td>
    			...
    			<td class="w3-center" onClick="getCaseStudiedTableByTotal(this,'getRoleWiseTimeTakenRTR',0);" >Total of all column on totals  <span   class="fa fa-download generateXLS w3-right"></span></td>
...
function toolTipData(countTable){
	...
	for ( var i = 0; i < roleCount.length; i++) {
		  ...
		  thetooltips[i] = "<table><tr><td style='color:red;padding:0'>"
								+ roleName[i]
								+ " : </td></tr><tr><td><span  style='color:#4897f1;padding:0'> Average Time(Hr) : </span><span><b>"
								+ roleCount[i]
								+ " </b></span></td></tr></table>";
	      }
