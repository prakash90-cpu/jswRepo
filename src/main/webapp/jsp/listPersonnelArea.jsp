			...
			<div id="myTableList">
				...
				<table
					...
					<thead>
						...
						<c:forEach var="list" items="${PersonnelAreaList}">
							<tr class="">

								<td>${list.id}</td>
								<td>${list.personnellAreaName}</td>
								<td>${list.shortName}</td>
								<td>${list.businessgroupId}</td>
								<td>${list.businessId}</td>
								
								<td><a href="/jsw-report/master/editPersonnelArea/${list.id}" class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a> <a
									href="/jsw-report/master/deletePersonnelArea/${list.id}" class=" w3-margin-right"><i
				...
				<br />
				<center>
					<a href="/jsw-report/master/addPersonnelArea">
