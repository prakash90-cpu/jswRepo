...
<form:form commandName="FunctionAppBean" action="/jsw-report/ApController/listNumberOfCasesProcessedAP">				
...
<div class='w3-container w3-round-xxlarge' style="background-color:#e3ecf9">
 ...
 <table  class="w3-table-all w3-hoverable w3-striped w3-border w3-small w3-center processTable process" stepname="${listOuterCases.name}">
   ...
   <c:forEach items="${listPeriod}" var="value">
						...
						<span title="download table"  onclick="getCaseCreatedAll('listCaseCreated<%=countGraphId++ %>', 'AP Number of Case Processed by user')" class="w3-badge fa fa-download w3-blue  w3-right w3-hover-green"></span>
...
<tr class="busi">
  ...
  <c:otherwise>
    <td class="w3-center firstTd">-</td>
										 ...
										 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
		<td class="w3-center stepName" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.day1}</a></td>
										<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.day2}</a></td>
											<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.day3}</a></td>
													<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.day4}</a></td>
										<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.day5}</a></td>
											<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.day6}</a></td>
						
							<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.day7}</a></td>
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
   		<td class="w3-center stepName" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.week1}</a></td>
										<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.week2}</a></td>
											<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.week3}<a></td>
													<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.week4}<a></td>
											
											
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
   		<td class="w3-center stepName" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.period1}</a></td>
										<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.period2}</a></td>
											<td class="w3-center" onclick="getCaseStudiedTableByUserNameRow(this,'getCasesProcessedAP',0);"><a>${listCases.period3}</a></td>
    </c:when>  
								...
								<u onclick="getCaseStudiedTableByUserName(this,'getCasesProcessedAP',0);" class="w3-hover-blue w3-hover-text-black">${listCases.count}</u>
								
								<span  onclick="getCaseStudiedTableByUserName(this,'getCasesProcessedExcelAP',1);" class="fa fa-download  w3-right w3-text-blue w3-hover-blue">
  			 ...
  			 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
          <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Day1</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Day2</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Day3</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Day4</td>   
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Day5</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Day6</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Day7</td>
						
						
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
         <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Week1</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Week2</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Week3</td>
  				<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Week4</td>
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
      <td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Month1</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Month2</td>
  			<td class="w3-center" onClick="getCaseStudiedTableByTotalRow(this,'getCasesProcessedAP',0);">Total of all Month1</td>
    </c:when>  
    			...
    			<td class="w3-center" >Total of all column on totals
    				...
    				<span  onclick="getCaseStudiedTableByTotal(this,'getCasesProcessedAP',0);" class="fa fa-download w3-right w3-hover-blue"></span>
