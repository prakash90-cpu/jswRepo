...
<%@ include file="Header.jsp" %>
  ...
  <div class="w3-container">
    <h3><b>Process  Started </b></h3>
  </div>
 

<br/>
 <center><a href="/jsw-report/externalSystems/listExtractionProgress">
<button class="w3-btn w3-left"  style="width:15%">Process Status</button></a></center>
   </div>
