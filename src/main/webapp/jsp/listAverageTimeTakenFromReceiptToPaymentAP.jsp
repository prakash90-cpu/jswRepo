...
<h2 class="w3-center w3-xxlarge"><i>AP</i></h2>
					...
					<b>Average Time Taken from Receipt To Payment (DMS+SAP)</b>
					</h4>	
				

<form:form commandName="FunctionAppBean" action="/jsw-report/ApController/listAverageTimeTakenFromReceiptToPaymentAP">				
...
<div class='w3-container w3-round-xxlarge' style="background-color:#e3ecf9">
 ...
 <table  class="w3-table-all w3-hoverable w3-striped w3-border  w3-center processTable process" stepname="${listOuterCases.name}">
   ...
   <c:forEach items="${listPeriod}" var="value">
						...
						<th class="w3-center">Total time (DAY)
						<span title="download table"  onclick="getCaseCreatedAll('listCaseCreated<%=countGraphId++ %>', 'AP Average Time Taken from Receipt To Payment')" class="w3-badge fa fa-download w3-blue  w3-right w3-hover-green"></span>
...
<tr class="busi">
 ...
 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
		<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.day1}</td>
										<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.day2}</td>
											<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.day3}</td>
													<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.day4}</td>
										<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.day5}</td>
											<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.day6}</td>
						
							<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.day7}</td>
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
   		<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.week1}</td>
										<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.week2}</td>
											<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.week3}</td>
													<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.week4}</td>
											
											
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
   		<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.period1}</td>
										<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.period2}</td>
											<td onclick="getCaseStudiedTableByStepnameRow(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-center w3-text-blue" style="cursor:pointer">${listCases.period3}</td>
    </c:when>  
								...
								<u onclick="getCaseStudiedTableByStepname(this,'getAverageTimeTakenFromReceiptToPaymentAP',0);" class="w3-hover-blue w3-hover-text-black"  style="cursor:pointer">${listCases.count}</u>
								
								<span  onclick="getCaseStudiedTableByStepname(this,'getAverageTimeTakenFromReceiptToPaymentExcelAP',1);" class="fa fa-download  w3-right w3-text-blue w3-hover-blue">
...
/*  $('[name="Roles"]').parent().parent().hide();
  ...
  */
  ...
  $('[name="CaseType"]').children("option").each(function(){
		 if($(this).val()=="ALL"){}
		 else{
