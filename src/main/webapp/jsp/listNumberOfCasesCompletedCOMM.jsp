...
<form:form commandName="FunctionAppBean" action="/jsw-report/CommController/listNumberOfCasesCompletedCOMM">				
					<table
 ...
 <table class="w3-table-all w3-hoverable w3-striped w3-border  w3-center" id="listCaseCreated">
   ...
   <c:forEach items="${listPeriod}" var="value">
						...
						<td class="w3-center"  style="background-color:#372d87;color:white">Count
							...
							<span title="download table"  onclick="getCaseCreatedAll('listCaseCreated', 'COMM Number of Case Completed')" class="w3-badge fa fa-download w3-blue  w3-right w3-hover-green"></span>
						...
						<c:forEach var="listCases" items="${listCasesCreated}">
							...
							<td class="">${listCases.name}</td>
									 ...
									 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
		<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.day1}</td>
										<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.day2}</td>
											<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.day3}</td>
													<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.day4}</td>
										<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.day5}</td>
											<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.day6}</td>
						
							<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.day7}</td>
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
   		<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.week1}</td>
										<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.week2}</td>
											<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.week3}</td>
													<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.week4}</td>
											
											
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
   		<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.period1}</td>
										<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.period2}</td>
											<td onclick="getCaseStudiedTableByStepnameRow(this,'getCaseCreatedCompanyCompletedCOMM',0);" class="w3-center">${listCases.period3}</td>
    </c:when>  
								...
								<u class="w3-hover-blue w3-hover-text-black" onclick="getCaseStudiedTableByStepname(this,'getCaseCreatedCompanyCompletedCOMM',0);">${listCases.count}</u>
								
								
								
								<span  onclick="getCaseStudiedTableByStepname(this,'getCaseCreatedCompanyCompletedExcelCOMM',1)" class="fa fa-download w3-right w3-hover-blue"></span>
  			 ...
  			 <c:choose>
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '7')}">
          <td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Day1</td>
  			<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Day2</td>
  			<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Day3</td>
  				<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Day4</td>   
  			<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Day5</td>
  			<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Day6</td>
  				<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Day7</td>
						
						
						
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '4')}">
         <td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Week1</td>
  			<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Week2</td>
  			<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Week3</td>
  				<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Week4</td>
    </c:when>  
        <c:when test="${fn:contains(FunctionAppBean.getDisplayBy(), '3')}">
      <td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Month1</td>
  			<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Month2</td>
  			<td class="w3-center" style="background-color:black;color:white" onClick="getCaseStudiedTableByTotalRow(this,'getCaseCreatedCompanyCompletedCOMM',0);">Total of all Month1</td>
    </c:when>  
    			...
    			<td class="w3-center" onClick="getCaseStudiedTableByTotal(this,'getCaseCreatedCompanyCompletedCOMM',0);" style="background-color:black;color:white">Total of all column on totals
    			
    			
    			
    			<span  onclick="getCaseStudiedTableByTotal(this,'getCaseCreatedCompanyCompletedCOMM',0)" class="fa fa-download generateXLS w3-right w3-hover-blue"></span>
...
function getCaseStudiedTableByStepname(thisVariable,ajaxUrl,download){
	$("#caseTable").html("");
	 // alert("table");
...
function getCaseStudiedTableByStepnameRow(thisVariable,ajaxUrl,download){
	$("#caseTable").html("");
	 // alert("table");
	var stepname=$(thisVariable).closest('tr').children('td:first').text();
	   // alert(firstColumnValue);
