			...
			<div id="myTableList">
				...
				<table
					...
					<thead>
						...
						<c:forEach var="list" items="${BusinessLocation}">
							<tr class="">
								...
								<td><a href="/jsw-report/master/editBusinessLoc/${list.businessId}/${list.locationId}" class="w3-margin-right"><i
										class="fa fa-edit fa-fw fa-2x w3-hover-text-orange"></i></a> <a
									href="/jsw-report/master/deleteLocBussiness/${list.businessId}/${list.locationId}" class=" w3-margin-right"><i
				...
				<br />
				<center>
					<a href="/jsw-report/master/addLocBusiness">
